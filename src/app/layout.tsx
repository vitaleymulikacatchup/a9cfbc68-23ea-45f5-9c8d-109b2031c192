...
export const metadata: Metadata = {
  title: "Pizzeria Delight | Authentic Italian Pizza",
  description: "Discover the taste of authentic Italian pizza at Pizzeria Delight. Served hot and fresh.",
  openGraph: {
    title: "Pizzeria Delight | Authentic Italian Pizza",
    description: "Discover the taste of authentic Italian pizza at Pizzeria Delight. Served hot and fresh.",
    images: [{
      url: "https://images.pexels.com/photos/8471703/pexels-photo-8471703.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Two gourmet pizzas with unique toppings: salmon with zucchini and classic margherita."
    }],
    type: "website"
  }
};
